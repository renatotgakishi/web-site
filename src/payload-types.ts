...
export interface Page {
  ...
  layout: (
    ...
    | {
        ...
        id?: string | null;
        blockName?: string | null;
        blockType: 'trabalhosBlock';
      }
    | {
        titulo?: string | null;
        id?: string | null;
        blockName?: string | null;
        blockType: 'depoimentosBlock';
      }
    | {
        titulo?: string | null;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "SobreBlock".
 */
export interface SobreBlock {
  titulo?: string | null;
  subtitulo?: string | null;
  texto1?: string | null;
  texto2?: string | null;
  citacao?: string | null;
  autorCitacao?: string | null;
  imagem?: (number | null) | Media;
  id?: string | null;
  blockName?: string | null;
  blockType: 'sobreBlock';
}
/**
 * This interface was referenced by `Config`'s JSON-Schema
...
export interface PagesSelect<T extends boolean = true> {
  ...
  layout?:
    ...
    | {
        ...
        sobreBlock?: T | SobreBlockSelect<T>;
        servicosBlock?:
          | T
          | {
              titulo?: T;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "SobreBlock_select".
 */
export interface SobreBlockSelect<T extends boolean = true> {
  titulo?: T;
  subtitulo?: T;
  texto1?: T;
  texto2?: T;
